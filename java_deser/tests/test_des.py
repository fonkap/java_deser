...
class TestDeserializer(TestCase):
    ...
    def test_unicast_ref(self):
        ...
        expected = {'objId': {'objNum': 1, 'space': {'time': 3, 'count': 4, 'unique': 2, '_cls': {'fields': [['count', 'S', ''], ['time', 'J', ''], ['unique', 'I', '']], '_uid': 1086053664494604050L, 'flags': '\x02', 'parent': None, '_name': 'java.rmi.server.UID'}, '_name': 'java.rmi.server.UID'}, '_cls': {'fields': [('objNum', 'J', ''), ('space', 'L', 'Ljava/rmi/server/UID;')], '_uid': 12060351809741186396L, 'flags': '\x02', 'parent': None, '_name': 'java.rmi.server.ObjID'}, '_name': 'java.rmi.server.ObjID'}, 'endpoint': {'port': 1190, 'host': u'dummyhost.com', '_cls': {'fields': [('host', 'L', 'String;'), ('port', 'I', '')], 'flags': '\x02', 'parent': None, '_name': 'TCPEndpoint'}, '_name': 'TCPEndpoint'}, '_cls': {'fields': [('endpoint', 'L', 'TCPEndpoint'), ('objId', 'L', 'ObjID')], 'flags': '\x02', 'parent': None, '_name': 'UnicastRef'}, '_name': 'UnicastRef'}
    ...
    def test_rmi_server_impl_stub(self):
        ...
        stub = parse(inp)
        expected = [{'data': {'ref': {'objId': {'objNum': 1, 'space': {'time': 3, 'count': 4, 'unique': 2, '_cls': {'fields': [['count', 'S', ''], ['time', 'J', ''], ['unique', 'I', '']], '_uid': 1086053664494604050L, 'flags': '\x02', 'parent': None, '_name': 'java.rmi.server.UID'}, '_name': 'java.rmi.server.UID'}, '_cls': {'fields': [('objNum', 'J', ''), ('space', 'L', 'Ljava/rmi/server/UID;')], '_uid': 12060351809741186396L, 'flags': '\x02', 'parent': None, '_name': 'java.rmi.server.ObjID'}, '_name': 'java.rmi.server.ObjID'}, 'endpoint': {'port': 1190, 'host': u'dummyhost.com', '_cls': {'fields': [('host', 'L', 'String;'), ('port', 'I', '')], 'flags': '\x02', 'parent': None, '_name': 'TCPEndpoint'}, '_name': 'TCPEndpoint'}, '_cls': {'fields': [('endpoint', 'L', 'TCPEndpoint'), ('objId', 'L', 'ObjID')], 'flags': '\x02', 'parent': None, '_name': 'UnicastRef'}, '_name': 'UnicastRef'}, '_cls': {'fields': [('ref', 'L', 'UnicastRef')], 'flags': '\x02', 'parent': None, '_name': 'RemoteObject'}, '_name': 'RemoteObject'}, '_cls': {'fields': [], '_uid': 2, 'flags': '\x02', 'parent': {'fields': [], '_uid': -1585587260594494182L, 'flags': '\x02', 'parent': {'fields': [], '_uid': -3215090123894869218L, 'flags': '\x03', 'parent': None, '_name': 'java.rmi.server.RemoteObject'}, '_name': 'java.rmi.server.RemoteStub'}, '_name': 'javax.management.remote.rmi.RMIServerImpl_Stub'}, '_name': 'javax.management.remote.rmi.RMIServerImpl_Stub'}]
